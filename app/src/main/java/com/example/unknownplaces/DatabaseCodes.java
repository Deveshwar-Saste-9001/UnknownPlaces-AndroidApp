...
import com.example.unknownplaces.Adapters.PlacesAdaptor;
import com.example.unknownplaces.Models.CategoryModel;
import com.example.unknownplaces.Models.PlacesListModel;
import com.example.unknownplaces.Models.PlacesModel;
                        ...
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot documentSnapshot : task.getResult()) {
                                ...
                                for (long x = 1; x < no_of_products + 1; x++) {
                                    if ((boolean) documentSnapshot.get("verified_" + x)) {
