package com.example.unknownplaces.Adapters;
...
import com.example.unknownplaces.ViewPlaceActivity;
            ...
            if (!placetitleText.isEmpty()) {
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent viewPlaceIntent = new Intent(itemView.getContext(), ViewPlaceActivity.class);
